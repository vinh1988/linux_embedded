...
def main():
    ...
    diagrams = [
        {"input": "component_diagram.md", "output": "component_diagram.png"},
        {"input": "module_diagram.md", "output": "module_diagram.png"},
        {"input": "layered_diagram.md", "output": "layered_diagram.png"},
        {"input": "thread_diagram.md", "output": "thread_diagram.png"}
    ]
    
    # Generate each diagram
    for diagram in diagrams:
        generate_diagram(diagram["input"], diagram["output"])
